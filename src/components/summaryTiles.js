...
function SummaryTiles({ data, title, tileClass }) {
  ...
  return (
    <div className="overviewstats" style={{ animationDelay: "0.1s" }}>
      <h3>
        <b> {i18n.t(title)} </b>:{" "}
        <span className="subtitle">about {lastupdated} Ago </span>
      </h3>
      ...
      <div className="map-stats" style={{ marginTop: "5px" }}>
        <div className={tileClassData} style={{ animationDelay: "0.1s" }}>
          ...
          <h5>
            {" "}
            <span>&uarr; {formatNumber(data.todayCases)} </span>
          </h5>
        </div>
        ...
        <div className={tileClassData} style={{ animationDelay: "0.1s" }}>
          ...
          <h5>
            <sup> &uarr; {formatNumber(data.todayDeaths)}</sup>
          </h5>
        </div>
        ...
        <div className={tileClassData} style={{ animationDelay: "0.1s" }}>
          ...
          <h5>
            {" "}
            {data.todayRecovered && (
              <sup> &uarr; {formatNumber(data.todayRecovered)}</sup>
            )}
          </h5>
        </div>
      </div>
